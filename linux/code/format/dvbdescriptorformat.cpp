...
//	CContentTree * SubRot;
	...
	AddFieldBranch(CurRot, pSLabel ,BaseBitIdx+16,descriptor_lenth * 8,
		FIELD_FMT_STR,(u64)(pDescriptorData+2));
}
...
//	CContentTree * SubRot;
	...
	if(descriptor_lenth > 6)
	{
		...
		AddFieldBranch(CurRot, pSLabel ,BaseBitIdx+64,(descriptor_lenth - 6)*8,
			FIELD_FMT_STR,(u64)(pDescriptorData+data_index));
	}
}
...
void CDVBDescriptor::ParseDescriptorDataBroadcast(CContentTree * parent, u8 * pDescriptorData,u32 BaseBitIdx)
{
	...
	AddFieldBranch(CurRot, pSLabel ,BaseBitIdx,8*Lenth,FIELD_FMT_STR,
...
//	CContentTree * SubRot;
	...
	AddFieldBranch(CurRot, pSLabel ,BaseBitIdx+16,32, FIELD_FMT_BCD , temp);
	...
	AddFieldBranch(CurRot, pSLabel ,BaseBitIdx+72,28, FIELD_FMT_BCD , temp);
...
//	CContentTree * SubRot;
	...
	while(data_index < (descriptor_lenth+2))
	{
		...
		AddFieldBranch(CurRot, pSLabel  ,BaseBitIdx+32,16,FIELD_FMT_BCD, temp);
		...
		AddFieldBranch(CurRot, pSLabel  ,BaseBitIdx+48,16,
			FIELD_FMT_MJD,pDescriptorData[data_index+6]*256 + pDescriptorData[data_index+7] );
		...
		AddFieldBranch(CurRot, pSLabel ,BaseBitIdx+48+16,24,FIELD_FMT_BCD, temp);
		...
		AddFieldBranch(CurRot, pSLabel  ,BaseBitIdx+88,16,FIELD_FMT_BCD, temp);	
...
//	CContentTree * SubRot;
	...
	while(data_index < (descriptor_lenth+2))
	{
		...
		AddFieldBranch(CurRot, pSLabel ,BaseBitIdx+32,8*pDescriptorData[data_index+3],
			FIELD_FMT_STR,(u64)(pDescriptorData+data_index+4));
...
//	CContentTree * SubRot;
	...
	while(data_index < (descriptor_lenth+2))
	{
		...
		AddFieldBranch(CurRot, pSLabel  ,BaseBitIdx+8,8*pDescriptorData[data_index],
			FIELD_FMT_STR,(u64)(pDescriptorData+data_index+1));
...
void CDVBDescriptor::ParseDescriptorService(CContentTree * parent, u8 * pDescriptorData,u32 BaseBitIdx)
{
	...
	AddFieldBranch(CurRot, pSLabel ,BaseBitIdx+32,8*pDescriptorData[data_index+1],
		FIELD_FMT_STR,(u64)(pDescriptorData+data_index+2));
